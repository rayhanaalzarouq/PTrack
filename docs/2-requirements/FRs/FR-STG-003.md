...
| AC2 | A project has not yet had a stage assigned | The user views the project | The system shall display a defined default/empty state rather than an incorrect value. Exact default is TBD pending Ambiguity #2 (AN-001) |
...
- Dependencies: Depends on FR-STG-001/FR-STG-002. The exact set of displayable stage values is pending resolution of Ambiguity #2 in AN-001.
---
## 6. Traceability
